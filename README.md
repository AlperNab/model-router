...
**Domain:** `AI Platform / Routing` · **Suite:** `AI Platform Core` · **Accent:** `#818cf8`
...
|---|---:|:---:|---|---|
| `request`<br>Request | text | Yes | — | Affects input: Request. |
...
| `provider_keys`<br>provider keys | text | No | — | Affects customization: provider keys. |
| `default_models`<br>default models | select | No | — | Affects customization: default models. |
| `privacy_mode`<br>privacy mode | select | No | cloud allowed | Affects customization: privacy mode. |
| `cost_cap`<br>cost cap | text | No | — | Affects customization: cost cap. |
| `latency_target`<br>latency target | text | No | — | Affects customization: latency target. |
| `fallback_chain`<br>fallback chain | text | No | — | Affects customization: fallback chain. |
| `task_routing_rules`<br>task routing rules | textarea | No | — | Affects customization: task routing rules. |
